...
namespace Prezentacijski_sloj
{
    public partial class FormPredvidanje : Form
    {
        ...
        private void FormPredvidanje_Load(object sender, EventArgs e)
        {
            ...
            trckBarInterval.Maximum=365;
            trckBarInterval.Minimum = 1;
            trckBarInterval.Value = 1;
            lblInterval.Text = trckBarInterval.Value.ToString();
        ...
        private void trckBarInterval_ValueChanged(object sender, EventArgs e)
        {
            lblInterval.Text = trckBarInterval.Value.ToString();
        }

        private void uiActionPokretanjePredvidanja_Click(object sender, EventArgs e)
        {
            BrisanjeKontrola();
            Prediction.PostaviInterval(trckBarInterval.Value);
        ...
        {
            foreach (var item in DinamicController.DohvatiSveKontrole())
            {
                this.Controls.Remove(item);
            }
            DinamicController.ResetirajVarijablePozicioniranja();
        }
    }
}
